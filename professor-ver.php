                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                        ...
                                        <select class="input-xs form-control in" name="nacionalidade_professor" required="">
                                            ...
                                            <option <?=($rs['nacionalidade_professor'] == "Moçambicana" ? "selected": ''); ?> value="Moçambicana">Moçambicana</option>

                                            <option <?=($rs['nacionalidade_professor'] == "Angolana" ? "selected": ''); ?> value="Angolana">Angolana</option>

                                            <option <?=($rs['nacionalidade_professor'] == "Zimbabweana" ? "selected": ''); ?> value="Zimbabweana">Zimbabweana</option>
