<!-- Sidebar -->
    <ul class="navbar-nav sidebar sidebar-dark accordion" style="background-color: #06003a;"  id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="painel_inicial.php">
        <div class="sidebar-brand-icon rotate-n-15">
          ...
          <i style="font-size:36pt">ISI</i>
        </div>
        <div class="sidebar-brand-text mx-3">CENTER<sup ><i class="rotate-n-15">TM</i></sup></div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="video.php">
          ...
          <span>Video-Aulas</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="disciplinas-disponivel.php">
          <i class="fas fa-fw fa-dollar-sign"></i>
          <span>Curso disponiveis</span></a>
      </li>
  ...
  <?php if($_SESSION['usuarioNivelAcesso'] < 3){ ?>
      ...
      <li class="nav-item">
        <a class="nav-link" href="mensalidades.php">
          <i class="fas fa-fw fa-dollar-sign"></i>
          <span>Mensalidades Geral</span></a>
      </li>
      <li class="nav-item">
