                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                        ...
                                        <select class="input-xs form-control in" name="local_de_emissao" required="">
                                            ...
                                            <option <?=($rs['local_de_emissao'] == "Soyo" ? "selected": ''); ?> value="Soyo" >Soyo</option>
                                            <option <?=($rs['local_de_emissao'] == "Nzeto" ? "selected": ''); ?> value="Nzeto" >Nzeto</option> 
                                            <option <?=($rs['local_de_emissao'] == "Luanda" ? "selected": ''); ?> value="Luanda" >Luanda</option> 
                                            <option <?=($rs['local_de_emissao'] == "Cabinda" ? "selected": ''); ?> value="Cabinda" >Cabinda</option> 
                                            <option <?=($rs['local_de_emissao'] == "Outro Local" ? "selected": ''); ?> value="Outro Local" >Outro Local</option>
