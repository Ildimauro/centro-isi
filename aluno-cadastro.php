                            ...
                            <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9 " >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                                        ...
                                        <input type="text" autofocus="" class="input-xs form-control in" name="nome_aluno" maxlength="70" value="" placeholder="Digite o nome do Aluno" required="" >

                                    </div>

                                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                        <label>Apelido</label>
                                        <input class="input-xs form-control in" name="apelido_aluno">
                                        <!-- <select class="input-xs form-control in" name="apelido_aluno">
