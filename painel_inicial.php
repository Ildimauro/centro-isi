...
?>
      ...
      ?>
          <p class="alert alert-success text-center">
            Seja vem vindo <b><?=$_SESSION['usuarioNome']  ?></b>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><input type="" readonly="" style="border: 0;" size="5" id="ganhos_mensal" value="" name=""><?=number_format($administracao->coleta_mes('Ago'),2);?> AOA</div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800" id=""><input type="" readonly="" style="border: 0;" size="5" id="ganhos_anual" value="" name=""><?=number_format($administracao->coleta_ano(),2); ?>  AOA</div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800" id=""><input type="" readonly="" style="border: 0;" size="5" id="ganhos_anual" value="" name=""><?=number_format($administracao->coleta_mensalidades(),2); ?> AOA</div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                    </div>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800" id=""><input type="" readonly="" style="border: 0;" size="5" id="ganhos_anual" value="" name=""><?=number_format($administracao->coleta_mensalidades()+$administracao->coleta_ano(),2); ?> AOA</div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                    </div>
