    ...
    $cedula = $url .$nome.'_Cédula_'. $numeroCedula .'.'. $extensao;
    	...
    	try {
    		...
    		$_SESSION['mensagem'] = "
                ...
                $sql="SELECT * FROM tabela_turma ORDER BY nr_turma";
	            $resulta = mysqli_query($conectar,$sql);

				$idAluno = $_GET['idAluno'];

				//Executa consulta
                $sqltb="SELECT * FROM tabela_aluno WHERE idAluno = '$idAluno' LIMIT 1";
				$result = mysqli_query($conectar,$qltb);
							...
							<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 " >
								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
									  	...
									  	<b>Apelido:</b> <input type="text" disabled class="input-xs form-control in" name="apelido" value="<?php echo $resultado['apelido']?>" placeholder="Apelido" required="" >
